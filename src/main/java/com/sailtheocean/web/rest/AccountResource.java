package com.sailtheocean.web.rest;

import com.codahale.metrics.annotation.Timed;
import com.sailtheocean.domain.user.Authority;
import com.sailtheocean.domain.user.PersistentToken;
...
import com.sailtheocean.service.MailService;
import com.sailtheocean.service.UserService;
import com.sailtheocean.web.rest.dto.UserDTO;
...
public class AccountResource {
    ...
    /**
     * Post /createshopuser -> create a new shop user
     */
    @RequestMapping(value = "/createshopuser", method = RequestMethod.POST, produces = "application/json", headers = "Accept=*/*")
    @Timed
    public ResponseEntity<?> createShopUserAccount( @RequestBody UserDTO userDTO, HttpServletRequest request){
        User shopuser = userService.createShopUserInformation(userDTO.getLogin(), userDTO.getPassword(),
