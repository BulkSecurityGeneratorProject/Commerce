...
public class UserResource {
    ...
    /**
     * Get /users/employee/:shopinfoid
     * Get all employee according to shop id.
     * @param shopinfoid
     * @return
     */
    @RequestMapping(value = "/users/employee/{shopinfoid}", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public List<User> getAllByShopId(@PathVariable String shopinfoid){
        log.debug("Rest request to get all users by shop id");
        return userRepository.findAllByShopId(Integer.parseInt(shopinfoid));
    }
